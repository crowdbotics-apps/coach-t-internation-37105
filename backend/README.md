...
## Project Structure
    ...
    ├── coach_t_internation_37105  # Django project configurations
...
1. Clone this repo and `cd coach_t_internation_37105`
...
2. Clone this repo and `cd coach_t_internation_37105`
